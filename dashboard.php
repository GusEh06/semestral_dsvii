        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row mt-4">
                    ...
                    <?php if ($auth->tienePermiso('colaboradores.leer')): ?>
                    ...
                    <?php if ($auth->tienePermiso('reportes.generar')): ?>
                        <div class="col-md-3 mb-3">
                    ...
                    <?php if ($auth->tienePermiso('usuarios.leer')): ?>
                        <div class="col-md-3 mb-3">
                    ...
                    <?php if ($auth->tienePermiso('vacaciones.crear')): ?>
                        <div class="col-md-3 mb-3">
